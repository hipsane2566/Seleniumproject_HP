...
public class QKART_Tests {
    ...
    XSSFRow row = null;
    XSSFCell cell = null; 
    final String filePath =System.getProperty("user.dir") + "/src/test/resources/TestResult.xlsx";
   ...
   ,dataProvider = "data-provider" , dataProviderClass = DP.class)
    ...
    @Test(description = "Verify re-registering an already registered user fails", priority = 2, groups = {
            "Sanity_test" }/* , dataProvider = "data-provider" , dataProviderClass = DP.class */,enabled = true)
    ...
    public void TestCase03() throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            assertTrue(elementText.contains("YONEX"),
    ...
    @Test(description = "Verify the existence of size chart for certain items and validate contents of size chart", priority = 4, groups = {
            "Regression_Test" } /* ,dataProvider = "data-provider" , dataProviderClass = DP.class*/,enabled = true)
    ...
    @Test(description = "Verify that the contents of the cart can be edited", priority = 6, groups = {
            "Regression_Test" },enabled = true, dataProvider = "data-provider" , dataProviderClass = DP.class
    )
    ...
    public void TestCase08() throws InterruptedException {
        Boolean status;
        int TC8_Qty = Integer.parseInt("60");
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        status = registration.registerUser("testUser", "abc@123", true);
        assertTrue(status, "Registration failed");
        ...
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        status = homePage.searchForProduct("Tan Leatherette Weekender Duffle");
        homePage.addProductToCart("Tan Leatherette Weekender Duffle");

        homePage.changeProductQuantityinCart("Tan Leatherette Weekender Duffle", TC8_Qty);
    ...
    @Test(description = "Verify that a product added to a cart is available when a new tab is added", priority = 10, dependsOnMethods = {
            "TestCase10" }, groups = { "Regression_Test" },enabled = true)
