...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        ...
        try {
            ...
            ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@class='MuiCardContent-root css-1qw96cp']/p[1]"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean isNoResultFound() {
        ...
        try {
            ...
            status = driver.findElementByXPath("//div[@class='loading MuiBox-root css-0']/h4").isDisplayed();
            return status;
        } catch (Exception e) {
            return status;
        }
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            List<WebElement> cartContents = cartParent.findElements(By.xpath("//*[@class='MuiBox-root css-1gjj37g']/div[1]"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                WebDriverWait wait = new WebDriverWait(driver, 30);
                wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@class='MuiBox-root css-1gjj37g']")));
