...
public class QkartSanity {
    ...
    public static Boolean TestCase01(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "Test Case 01", "Verify User Registration");
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "Test Case 01", "Failed to Verify User Registration");
            // Return False as the test case Fails
            return false;
        } else {
            logStatus("TestCase 1", "Test Case Pass. User Registration Pass", "PASS");
            takeScreenshot(driver, "Test Case 01", "User Registration Pass");
        }
        ...
        if (!status) {
            logStatus("End TestCase", "Test Case 1: Verify user Registration : ", status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Test Case 01", "Verify User Registration Failed");
            return false;
        }
        ...
        logStatus("End TestCase", "Test Case 1: Verify user Registration : ", status ? "PASS" : "FAIL");
        takeScreenshot(driver, "Test Case 01", "End TestCase Verify User Registration Pass ");
        return status;
    }
    ...
    public static Boolean TestCase02(RemoteWebDriver driver) throws InterruptedException {
        ...
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        takeScreenshot(driver, "Test Case 02", "Login Page");
        status = registration.registerUser("testUser", "abc@123", true);
        logStatus("Test Step", "User Registration : ", status ? "PASS" : "FAIL");
        if (!status) {
            logStatus("End TestCase", "Test Case 2: Verify user Registration : ", status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Test Case 02", "User Registration Pass");
            return false;
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        ...
        takeScreenshot(driver, "Test Case 03", "Login page");
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "Test Case 03", "Failed to Search given product");
            return false;
        }
        ...
        if (searchResults.size() == 0) {
            ...
            takeScreenshot(driver, "Test Case 03", "No result for the given search string");
            return false;
        }
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (!elementText.toUpperCase().contains("YONEX")) {
                logStatus("TestCase 3", "Test Case Failure. Test Results contains un-expected values: " + elementText,
                        "FAIL");
                        takeScreenshot(driver, "Test Case 03", "Results contains un-expected values");
                return false;
            }
        }

        logStatus("Step Success", "Successfully validated the search results ", "PASS");
        takeScreenshot(driver, "Test Case 03", "Validated the search result pass");
        // SLEEP_STMT_02
        Thread.sleep(2000);
        ...
        if (!status) {
            logStatus("TestCase 3", "Test Case Failure. Unable to search for given product", "FAIL");
            takeScreenshot(driver, "Test Case 03", "search for given product Failed");
            return false;
        }
        ...
        if (searchResults.size() == 0) {
            if (homePage.isNoResultFound()) {
                ...
                takeScreenshot(driver, "Test Case 03", "Validated that no products message is displayed pass");
            }
            logStatus("TestCase 3", "Test Case PASS. Verified that no search results were found for the given text",
                    "PASS");
                    takeScreenshot(driver, "Test Case 03", "no search results were found for the given text pass");
        } else {
            logStatus("TestCase 3", "Test Case Fail. Expected: no results , actual: Results were available", "FAIL");
            takeScreenshot(driver, "Test Case 03", "no search results were found for the given text fail");
            return false;
        }
    ...
    public static Boolean TestCase04(RemoteWebDriver driver) throws InterruptedException {
        ...
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        takeScreenshot(driver, "Test Case 04", "Login page");
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                ...
                takeScreenshot(driver, "Test Case 04", "Size chart is visible");
                // Verify if size dropdown exists
                status = result.verifyExistenceofSizeDropdown(driver);
                logStatus("Step Success", "Validated presence of drop down", status ? "PASS" : "FAIL");
                takeScreenshot(driver, "Test Case 04", "Validated presence of drop down");
                // Open the size chart
                if (result.openSizechart()) {
                    ...
                    if (result.validateSizeChartContents(expectedTableHeaders, expectedTableBody, driver)) {
                        ...
                        takeScreenshot(driver, "Test Case 04", "validated contents of Size Chart Link");
                    } else {
                        logStatus("Step Failure", "Failure while validating contents of Size Chart Link", "FAIL");
                        takeScreenshot(driver, "Test Case 04", "validating contents of Size Chart Link fail");
                    }
                    ...
                    takeScreenshot(driver, "Test Case 04", "Failure to open Size Chart");
                    return false;
                }

            } else {
                logStatus("TestCase 4", "Test Case Fail. Size Chart Link does not exist", "FAIL");
                takeScreenshot(driver, "Test Case 04", "Size Chart Link does not exist");
                return false;
            }
        }
        logStatus("TestCase 4", "Test Case PASS. Validated Size Chart Details", "PASS");
        takeScreenshot(driver, "Test Case 04", "Validated Size Chart Details pass");
        return status;
    }
    ...
    public static Boolean TestCase05(RemoteWebDriver driver) throws InterruptedException {
        ...
        Register registration = new Register(driver);
        registration.navigateToRegisterPage();
        takeScreenshot(driver, "Test Case 05", "Login Page");
        // Register a new user
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("TestCase 5", "Test Case Failure. Happy Flow Test Failed", "FAIL");
            takeScreenshot(driver, "Test Case 05", "Registration Failed");
        }
        ...
        if (!status) {
            ...
            takeScreenshot(driver, "Test Case 05", "Login failed");
        }
        ...
        takeScreenshot(driver, "Test Case 05", "product1 added to cart");
        status = homePage.searchForProduct("Tan");
        homePage.addProductToCart("Tan Leatherette Weekender Duffle");
        takeScreenshot(driver, "Test Case 05", "product2 added to cart");
        // Click on the checkout button
        homePage.clickCheckout();
        takeScreenshot(driver, "Test Case 05", "checkout page");
        // Add a new address on the Checkout page and select it
        Checkout checkoutPage = new Checkout(driver);
        checkoutPage.addNewAddress("Addr line 1 addr Line 2 addr line 3");
        takeScreenshot(driver, "Test Case 05", "Add address pass");
        checkoutPage.selectAddress("Addr line 1 addr Line 2 addr line 3");
        takeScreenshot(driver, "Test Case 05", "Address is selected");

        // Place the order
        checkoutPage.placeOrder();
        takeScreenshot(driver, "Test Case 05", "order placed");
        ...
        takeScreenshot(driver, "Test Case 05", "Redirected to Thanks page");
        // Go to the home page
        homePage.navigateToHome();
        takeScreenshot(driver, "Test Case 05", "HomePage");
        Thread.sleep(3000);
        ...
        takeScreenshot(driver, "Test Case 05", "Happy flow test completed");
        return status;
    }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        registration.navigateToRegisterPage();
        takeScreenshot(driver, "Test Case 06", "Register Page");
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("Step Failure", "User Perform Register Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 6:  Verify that cart can be edited: ", status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Test Case 06", "Registration Failed");           
            return false;
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 6:  Verify that cart can be edited: ", status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Test Case 06", "Login failed");
            return false;
        }
        homePage.navigateToHome();
        ...
        logStatus("End TestCase", "Test Case 6: Verify that cart can be edited: ", status ? "PASS" : "FAIL");
        takeScreenshot(driver, "Test Case 06", "Cart edit");
        return status;
    }
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        logStatus("Start TestCase", "Test Case 8: Verify that cart contents are persisted after logout", "DONE");
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 8:  Verify that cart contents are persited after logout: ",
                    status ? "PASS" : "FAIL");
            return false;
        }
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        logStatus("End TestCase", "Test Case 8: Verify that cart contents are persisted after logout: ",
                status ? "PASS" : "FAIL");
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        if(!status){
            logStatus("End TestCase",
                "Test Case 11: Verify that contact us option is working correctly ",status ?
                "PASS" : "FAIL");
    }
