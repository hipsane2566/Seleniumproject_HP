...
public class Checkout {
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            WebElement parentBox = driver.findElement(By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']//div[1]/p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']"));
            List<WebElement> allBoxes = parentBox.findElements(By.xpath("//*[@class='address-item not-selected MuiBox-root css-0']"));

            for (WebElement box : allBoxes) {
                if (box.findElement(By.xpath("//*[@class='address-item not-selected MuiBox-root css-0']/div[1]/p")).getText().replaceAll(" ", "")
                        .equals(addressToSelect.replaceAll(" ", ""))) {
                    box.findElement(By.xpath("//div[@class='address-item not-selected MuiBox-root css-0']//div[1]/p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']")).click();
                    return true;
                }
            }
